...
public class PlayerAttack : MonoBehaviourPun
{
    ...
    public void AttackWithAngle()
    {
        ...
        if (targets[0] != null)
        {
            ...
            else if (targets[0].transform.CompareTag("Player") && !targets[0].transform.parent.gameObject.GetPhotonView().IsMine && !targets[0].GetComponent<PlayerController>().IsDead)
            {
